import{_ as O}from"./C7a6sH2f.js";import{_ as C}from"./BAJOmgxM.js";import{F as s,_ as d,v as _}from"./C1XiG2KJ.js";import{Z as P,e as q,r as y,k as m,g as U,c as u,a as F,x as L,b as p,t as T,j as e,C as A,a7 as R,o as S}from"#entry";import{g as b}from"./XIrV35nz.js";const g={name:{rules:["required"],type:s.TEXT},description:{rules:["required"],type:s.TEXT},file:{rules:["fileRequired"],type:s.FILE}},G={name:{rules:["required"],type:s.TEXT},description:{rules:["required"],type:s.TEXT}};var i=(t=>(t.ADD_ETIQUETTE_TEMPLATE="AddEtiquetteTemplate",t.UPDATE_ETIQUETTE_TEMPLATE="UpdateEtiquetteTemplate",t.TOGGLE_ETIQUETTE_TEMPLATE="ToggleEtiquetteTemplate",t.SHOW_ETIQUETTE_PREVIEW="ShowEtiquettePreview",t))(i||{});const v=[{name:i.ADD_ETIQUETTE_TEMPLATE,show:!1},{name:i.UPDATE_ETIQUETTE_TEMPLATE,show:!1},{name:i.TOGGLE_ETIQUETTE_TEMPLATE,show:!1},{name:i.SHOW_ETIQUETTE_PREVIEW,show:!1}],M=()=>({etiquette_templates:[{description:"PROCESO 203030",file:null,name:"TEMPLATE 203030",template:`^XA
            ^CI28
            ^FX Título
